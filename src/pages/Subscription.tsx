...
const Subscription = () => {
  ...
  const { createSubscription } = useSubscriptionCreation({
    selectedPlan: selectedPlanObj || subscriptionPlans[0],
  ...
  const handleSubscribe = async () => {
    ...
    // Use the new subscription creation hook
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mt-8 space-y-4">
          <Button
            ...
            disabled={!selectedPlan || !hasWallet}
            className="w-full"
            size="lg"
          >
